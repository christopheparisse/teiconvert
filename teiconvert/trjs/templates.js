...
return {
	checkCodeName: function(e) { return checkCodeName(e); },
	checkCodeType: function(e) { return checkCodeType(e); },
	checkTierType: function(e) { return checkTierType(e); },
    checkContentType: checkContentType,
	codeToName: function(v) { return codeToName(v); },
	definedTierType: function(e) { return definedTierType(e); },
	codeToNameInit: function(v) { return codeToNameInit(v); },
	eventKeydownParticipant: function(p) { return eventKeydownParticipant(p); },
	eventKeydownTMCode: eventKeydownTMCode,
	eventKeydownTMTier: eventKeydownTMTier,
    eventKeydownTMMeta: eventKeydownTMMeta,
	imbricationLevels: function() { return imbricationLevels(); },
	loadMetadata: function() { loadMetadata(); },
	loadPersons: function() { loadPersons(); },
	loadTemplates: function() { loadTemplates(); },
	nameToCode: function(v) { return nameToCode(v); },
	MediaDesc: function() { return MediaDesc(); },
	Person: function() { return Person(); },
	readMediaInfo: function(p) { readMediaInfo(p); },
	readTemplates: function(p) { readTemplates(p); },
	readMetadata: function(p) { readMetadata(p); },
	readPersons: function(p) { readPersons(p); },
	saveTEIHeaderToString: function() { return saveTEIHeaderToString(); },
	setMedia: function(p) { setMedia(p); },
	splitDoubleText: function(p) { return splitDoubleText(p); },
